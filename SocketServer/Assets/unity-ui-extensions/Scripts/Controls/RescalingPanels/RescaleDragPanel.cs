...
namespace UnityEngine.UI.Extensions
{
    ...
    public class RescaleDragPanel : MonoBehaviour, IPointerDownHandler, IDragHandler
    {
        ...
        Vector2 ClampToWindow(PointerEventData data)
        {
            ...
            float clampedX = Mathf.Clamp(rawPointerPosition.x, canvasCorners[0].x+20, canvasCorners[2].x-20);
            float clampedY = Mathf.Clamp(rawPointerPosition.y, canvasCorners[0].y+20, canvasCorners[2].y-20);
